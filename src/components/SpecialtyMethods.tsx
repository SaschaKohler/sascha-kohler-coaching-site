...
const specialtyMethods = [
  {
    ...
    description:
      "Als Erfinder der KLARE Methode (Klarheit - Lebendigkeit - Ausrichtung - Realisierung - Entfaltung) habe ich ein strukturiertes 5-Schritte-System entwickelt, das Menschen dabei unterstützt, ein kongruentes und authentisches Leben zu führen. Diese Methode wende ich konsequent an und vermittle sie weiter.",
    icon: SparklesIcon,
    benefits: [
  ...
  },
  {
    ...
    description:
      "Eine kraftvolle Methode zur Selbsterkundung, bei der Sie verschiedene Rollen Ihres Lebens spielerisch erforschen. Durch den Wechsel der Perspektiven entdecken Sie neue Facetten Ihrer Persönlichkeit und finden kreative Lösungen für Ihre Herausforderungen.",
    icon: MicrophoneIcon,
    benefits: [
  ...
  },
  {
    ...
    description:
      "Mit Humor und direkter Ansprache durchbrechen wir festgefahrene Denkmuster. Die provokative Methode nutzt paradoxe Interventionen und humorvolle Übertreibungen, um neue Sichtweisen zu ermöglichen und schnelle Veränderungen anzustoßen.",
    icon: FaceSmileIcon,
    benefits: [
      ...
      <div className="container-custom">
        ...
        >
          ...
          <p className="text-lg text-neutral-600 max-w-3xl mx-auto">
            Diese bewährten Techniken führen besonders schnell zu nachhaltigen
            Ergebnissen. Sie alle haben eines gemeinsam: Den Menschen in den
            Dialog mit sich selbst zu bringen.
          </p>
        </motion.div>
            ...
            >
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
                ...
                <div className="text-center lg:text-left">
                  <div
                    className={`w-16 h-16 mx-auto lg:mx-0 mb-4 rounded-2xl flex items-center justify-center ${
        ...
        >
          <div className="bg-gradient-to-r from-primary-600 to-secondary-600 rounded-2xl p-8 text-white">
            ...
            <p className="mb-6 opacity-90">
              In einem unverbindlichen Erstgespräch erfahren Sie, welche Methode
              für Ihre aktuelle Situation am besten geeignet ist.
            </p>
            <a
              href="#contact"
