        ...
        <div className="container mx-auto px-6 py-12">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-warm-brown max-w-3xl mx-auto leading-relaxed">
              ...
              Entwicklung. Entdecken Sie praktische Ansätze für mentale Stärke und
            ...
            <div className="grid md:grid-cols-2 gap-0">
              ...
              <div className="p-6 md:p-8 bg-warm-white">
                <div className="flex items-center mb-4">
                  ...
                  <div className="ml-3">
                    <p className="font-medium text-dark-brown">{blogPosts[0].author}</p>
                    <p className="text-sm text-warm-brown">
                      {formatDate(blogPosts[0].date)}
                    </p>
                  </div>
                </div>
                <p className="text-warm-brown mb-4 leading-relaxed">{blogPosts[0].excerpt}</p>
            ...
            >
              <div className="h-48 relative">
                <div className="absolute inset-0 bg-gradient-to-br from-deep-brown to-klare-r flex items-center justify-center">
                  ...
                  <div className="text-warm-white/40 text-6xl font-serif">📝</div>
                </div>
              </div>
              <div className="p-6">
                ...
                <p className="text-warm-brown mb-4 leading-relaxed">{post.excerpt}</p>
                <div className="flex items-center">
                  ...
                  <p className="ml-3 text-sm text-warm-brown">{post.author}</p>
                </div>
              </div>
            </Link>
          ))}
        ...
        <div className="bg-gradient-to-r from-deep-brown to-klare-r text-warm-white rounded-2xl p-8 md:p-12 mb-16">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="mb-8 leading-relaxed">
              Erhalten Sie neue Blog-Artikel und Einblicke zu Mentaltraining und
          ...
          <div className="grid md:grid-cols-3 gap-0">
            <div className="md:col-span-1 relative h-full min-h-[280px] md:min-h-full bg-gradient-to-br from-deep-brown to-klare-r flex items-center justify-center p-8">
              <div className="bg-warm-white/10 w-48 h-48 rounded-full overflow-hidden mx-auto relative border-4 border-warm-white/20">
                <div className="absolute inset-0 flex items-center justify-center">
                  <span className="text-6xl font-serif text-warm-white">SK</span>
                </div>
              </div>
            </div>
            <div className="md:col-span-2 p-8 bg-warm-white">
              ...
              <p className="text-warm-brown mb-4 leading-relaxed">
                ...
                Alltagsanwendung. Dabei liegt der Fokus auf Selbsterfahrung und 
                authentischer Transformation durch Kongruenz.
              </p>
              <div className="mt-6">
                <Link
                  href="/ueber-mich"
